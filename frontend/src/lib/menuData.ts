export type MenuItem = {
  /** Backend menu item id — undefined for the static fallback data below, always present when sourced from the API (see lib/catalog.ts). Needed to add an item to the cart. */
  id?: number;
  name: string;
  price: number;
  veg: boolean;
